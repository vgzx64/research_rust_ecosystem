        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(string(Package::RepositoryUrl))
                    .col(string(Package::Homepage))
                    .col(string(Package::Description))
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(string(Vulnerability::Summary))
                    .col(string(Vulnerability::Details))
